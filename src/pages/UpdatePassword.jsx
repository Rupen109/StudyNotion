                ...
                <div className="max-w-[500px] p-4 lg:p-8">
                    ...
                    <form onSubmit={handleOnSubmit}>
                        <label className="relative">
                            ...
                            <input required type={showPassword ? "text" : "password"} name="password" value={password} onChange={handleOnChange} placeholder="Enter Password" className="form-style w-full !pr-10 rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5" />
                        ...
                        <label className="relative mt-3 block">
                            ...
                            <input required type={showConfirmPassword ? "text" : "password"} name="confirmPassword" value={confirmPassword} onChange={handleOnChange} placeholder="Confirm Password" className="form-style w-full !pr-10 rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5" />
