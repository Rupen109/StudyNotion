...
const ExploreMore = () => {
    ...
    const setMyCards = (element) => {
        ...
        console.log(result , "result wala");
    ...
    return (
      ...
      px-1 py-1"
            ...
            <div className="lg:absolute gap-10 justify-center lg:gap-0 flex lg:justify-between flex-wrap w-full lg:bottom-[0] lg:left-[50%] lg:translate-x-[-50%] lg:translate-y-[50%] text-black lg:mb-0 mb-7 lg:px-12 px-3">
