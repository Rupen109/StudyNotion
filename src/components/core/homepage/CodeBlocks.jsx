...
// import bg from "../../../assets/Images/Ellipse1.png";
...
const CodeBlocks = ({ position, heading, subheading, ctabtn1, ctabtn2, codeblock, backgroudGradient, codeColor }) => {
    return (
        <div className={`flex ${position} my-20 justify-center gap-10`}>
            ...
            {/*Section 2*/}
            <div className="bg-hero2 bg-cover bg-bottom">
                <div className=" h-fit  flex flex-row text-10[px] w-[100%] py-4 lg:w-[500px] bg-gradient-to-r from-slate-900 ">
                    {/*HW -> BG gradient*/}
